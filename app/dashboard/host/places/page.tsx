...
const initialPlaces = [
  {id:'1',title:'日本体育大学医療専門学校（6〜8月）',area:'東京',type:'キッチンカー',status:'published',pinned:true,applications:8,deadline:'2026年8月1日',updatedAt:'2026年5月30日'},
  {id:'2',title:'大阪公立大学りんくうキャンパス',area:'大阪',type:'キッチンカー',status:'published',pinned:false,applications:3,deadline:'2026年6月30日',updatedAt:'2026年5月28日'},
...
export default function PlaceManagePage() {
  ...
  const refreshDate = (id: string) => {
    ...
    showToast('更新日時をリセットしました。一覧上位に表示されます')
  }
