...
ご提出いただいた書類について、確認の結果、再提出をお願いすることとなりました。
...
株式会社nav`,
  ...
  },
  {
    ...
    label: '申込の審査結果',
    to: '出店者',
    when: '運営または募集者が申込を承認・不採用にしたとき',
    subject: '【出店コネクトナビ】{{案件名}} のお申し込み結果',
    body: `{{お名前}} 様

いつも出店コネクトナビをご利用いただきありがとうございます。

お申し込みいただいた案件の結果をお知らせいたします。
...
株式会社nav`,
    vars: [
      { name: '宛名', note: '募集者の名前' },
      { name: '案件名', note: '申し込まれた案件の名前' },
      { name: '屋号', note: '申し込んだ出店者の屋号' },
      { name: '希望日', note: '出店を希望する日' },
    ],
  },
  {
    key: 'new-message',
...
出店コネクトナビ`,
    vars: [
      { name: '種別', note: '出店者または募集者' },
      { name: 'お名前', note: '登録された名前' },
...
株式会社nav`,
    vars: [
      ...
      { name: '出店日', note: '取り消された出店日' },
      { name: '取消しの理由', note: '運営が入力した理由。未入力なら空' },
    ],
  },
  {
    key: 'cancel-host',
