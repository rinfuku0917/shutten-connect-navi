...
株式会社nav`,
  ...
  },
  {
    ...
    label: '出店料の入金の督促',
    to: '出店者',
    when: '運営が入金状況の一覧から「入金を督促する」を押したとき',
    subject: '【出店コネクトナビ】出店料のお支払いについてのご確認',
    body: `{{屋号}} 様

いつも出店コネクトナビをご利用いただきありがとうございます。
下記の出店料について、本日時点でご入金を確認できておりません。
...
お手数ですが、ご入金の状況をご確認いただけますでしょうか。
すでにお振り込みいただいている場合は、行き違いの可能性がございます。
マイページの「請求書」から「振り込みました」をお知らせいただけますと、
こちらで確認いたします。

ご不明な点やお支払いのご相談がございましたら、
このメールにご返信ください。
...
株式会社nav`,
    vars: [
      ...
      { name: '請求書番号', note: '2026-0042 のような番号' },
      { name: '対象月', note: '2026-09 のような対象の月' },
      { name: '金額', note: 'ご請求額（税込）' },
      { name: '支払期限', note: '支払期限。設定していなければ「お早めに」' },
    ],
  },
  {
    key: 'cancel-admin',
