...
export default function TermsPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#FFF9E6', width: '100%', maxWidth: '100vw', overflowX: 'hidden' }}>
      ...
      <div style={{ background: 'linear-gradient(rgba(245,166,35,0.78), rgba(232,130,12,0.88)), url(/hero-terms.webp) center/cover no-repeat', padding: '72px 16px', textAlign: 'center' }}>
