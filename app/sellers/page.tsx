  ...
  return (
    <div style={{background:'#FFF8F0',minHeight:'100vh'}}>
      ...
      <div style={{background:'linear-gradient(rgba(0,0,0,0.45),rgba(0,0,0,0.45)),url(/hero-sellers.png) center/cover no-repeat',padding:'80px 24px',textAlign:'center',minHeight:'300px',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
        <h1 style={{fontSize:'clamp(32px,5vw,56px)',fontWeight:'900',color:'#fff',marginBottom:'12px',textShadow:'0 2px 8px rgba(0,0,0,0.5)'}} style={{color:'#fff',fontSize:'clamp(28px,4vw,44px)',fontWeight:'900',textShadow:'0 2px 8px rgba(0,0,0,0.5)',marginBottom:'12px'}}>出店者を探す</h1>
